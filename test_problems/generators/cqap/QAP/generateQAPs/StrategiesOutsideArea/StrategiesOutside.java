...
public interface StrategiesOutside {
    
    public void setParameters(Stack<Integer> freeSockets, double percentLow, double[] percentZeros);
    
    public void arrangeDistance(DistanceMatrixWithDistr newDistance, DiscreteDistributionWithHoles fillDistance);
