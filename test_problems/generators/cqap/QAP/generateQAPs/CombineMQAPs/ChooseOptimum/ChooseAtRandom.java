...
public class ChooseAtRandom implements ChoseOptimSolution{
    
    private Random r = new Random();
    
    @Override
    public void selectScal(double[] d){
        System.out.println("Random selection does not need scalarization");
    }
    
    @Override
    public Solution chose(ArchiveSolutions nda){
            int tempSol = (int)Math.floor(r.nextDouble() * nda.size());
            return nda.getNthSolution(tempSol);
    }
}
