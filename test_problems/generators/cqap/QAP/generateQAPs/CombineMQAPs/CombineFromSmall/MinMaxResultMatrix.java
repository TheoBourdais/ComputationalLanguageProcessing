...
public class MinMaxResultMatrix extends MinSumResultMatrix{
    ...
    public MinMaxResultMatrix(OverlappingStrategy str, OverlappingStrategy strA, FillUpRandomMatrix f){
        strategy = str;
        strategyA = strA;
