...
public class FillUpChebMatrix extends FillUpMatrix{
    ...
    public FillUpChebMatrix(DiscreteDistribution fillD, DiscreteDistribution fillF){
        fillFlow = fillF;
        fillDistance = fillD;
    }

    public FillUpChebMatrix(){}
