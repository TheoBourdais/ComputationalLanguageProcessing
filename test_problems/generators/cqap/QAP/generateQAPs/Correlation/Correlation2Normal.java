 ...
 * @author madalina
 */
public class Correlation2Normal implements CorrelationInterface{
    
    //double[] limits;
    double corrNum;
    
    public Correlation2Normal(double corr){
        corrNum = corr;
    }
    ...
    public double correlation(double inputs, double correlation, DiscreteDistribution distr){
        ...
        double output = distr.generateBasic() * Math.sqrt(1.0 - Math.pow(correlation, 2)) + inputs * correlation;
