...
public interface CorrelationInterface {
    ...
    public double correlation(double input1, double correlation, DiscreteDistribution distr);
    public double correlation(double input1, DiscreteDistribution distr);
