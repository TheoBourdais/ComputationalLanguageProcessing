 ...
 * @author madalina
 */
public interface CombineProblems {
         public GenerateProblems combine(GenerateProblems[] listP, OverlappingStrategy str, FillUpRandomMatrix fill);
         public GenerateProblems combine(GenerateProblems[] listP, ChoseOptimSolution chose);

         public OverlappingStrategy getStrategy();
         public void setStrategy(OverlappingStrategy strategy);
}
