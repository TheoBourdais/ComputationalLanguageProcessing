...
import QAP.general.GenerateProblem.CombineProblems;
import QAP.general.GenerateProblem.GenerateProblems;
import QAP.generateQAPs.CombineMQAPs.ChooseOptimum.ChoseOptimSolution;

public interface CombineProblemsMQAPs extends CombineProblems{
         public GenerateProblems[] generateKnownOptim(GenerateProblems[] listP, ChoseOptimSolution chose);
