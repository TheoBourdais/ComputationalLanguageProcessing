...
import QAP.general.GenerateProblem.GoodnessProblem;
import QAP.generateQAPs.Distance.DistanceMatrixWithDistr;
import QAP.generateQAPs.Flows.FlowMatrixWithDistr;
import java.util.*;

public abstract class GoodnessProblemMQAPs implements GoodnessProblem{

    public abstract void setParamaters(DistanceMatrixWithDistr dist, FlowMatrixWithDistr f);
    public abstract void resetMeasurements();
    public abstract void addMeasurements();
    public abstract Formatter writeAddedMeasurements();
    public abstract void writeAdd2Measurements(String nameF);
}
